...
json_path = os.path.join(repo_dir, 'one_way_qkd_simulation_results_dn.json')
...
plt.ylabel('Depolarizing noise $Q$', fontsize=16)
plt.xticks(ticks=circle_P, labels=circle_P, fontsize=14)
plt.yticks(fontsize=14)
plt.grid(False)
plt.tight_layout()
circle_plot_path = os.path.join(output_folder, 'qer_z_circle_plot_dn.png')
...
plt.grid(False)
plt.tight_layout()
hypercube_plot_path = os.path.join(output_folder, 'qer_z_hypercube_plot_dn.png')
...
plt.title('Comparison of $Q$ circle vs hypercube: depolarizing noise', fontsize=16)
...
plt.grid(False)
plt.tight_layout()
comparison_plot_path = os.path.join(output_folder, 'qer_z_comparison_plot_dn.png')
