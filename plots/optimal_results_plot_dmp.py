...
# Load all datasets
non_optimal_data = load_json("one_way_qkd_simulation_results_dmp.json")
optimal_data_circle = load_json("optimal_results_qer_dmp_circle.json")
optimal_data_hypercube = load_json("optimal_results_qer_dmp_hypercube.json")
...
plt.title("Comparison of $Q$ vs $P$ for optimal and non-optimal cases: amplitude-phase damping noise", fontsize=16)
...
# Save plot locally
plt.savefig("optimal_results_qer_z_vs_p_dmp.png")
